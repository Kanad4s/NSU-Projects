CREATE TABLE IF NOT EXISTS "Самолеты" (
    "id" INTEGER NOT NULL UNIQUE FOREIGN KEY "Модели_изделий"("id") ON DELETE CASCADE ON UPDATE RESTRICT,
    "категория" INTEGER NOT NULL FOREIGN KEY "Категории_самолетов"("id") ON DELETE CASCADE ON UPDATE RESTRICT,
