...
CREATE TABLE IF NOT EXISTS "Участки_цехов" (
	"id" SERIAL PRIMARY KEY,
	"цех" INTEGER NOT NULL REFERENCES "Цеха"("id") ON DELETE CASCADE ON UPDATE RESTRICT,
	"начальник" INTEGER NOT NULL REFERENCES "ИТ_персонал"("id") ON DELETE RESTRICT ON UPDATE CASCADE,
