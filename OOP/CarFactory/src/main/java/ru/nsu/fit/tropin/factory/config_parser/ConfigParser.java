package ru.nsu.fit.tropin.factory.config_parser;
...
public class ConfigParser {
    ...
    public int getSupplierDelay(){
        int supplierDelay = Integer.parseInt(configProperties
                .getProperty("SupplierDelay", DEFAULT_VALUE));
        return supplierDelay;
    }

    public int getDealerDelay(){
        int dealerDelay = Integer.parseInt(configProperties
                .getProperty("DealerDelay", DEFAULT_VALUE));
        return dealerDelay;
    }

    public int getWarehouseBodyCapacity(){
        int warehouseBodyCapacity = Integer.parseInt(configProperties
                .getProperty("WarehouseBodyCapacity", DEFAULT_VALUE));
        return warehouseBodyCapacity;
    }

    public int getWarehouseMotorCapacity(){
        int warehouseMotorCapacity = Integer.parseInt(configProperties
                .getProperty("WarehouseMotorCapacity", DEFAULT_VALUE));
        return warehouseMotorCapacity;
    }

    public int getWarehouseAccessoryCapacity(){
        int warehouseAccessoryCapacity = Integer.parseInt(configProperties
                .getProperty("WarehouseAccessoryCapacity", DEFAULT_VALUE));
        return warehouseAccessoryCapacity;
    }

    public int getWarehouseAutoCapacity(){
        int warehouseAutoCapacity = Integer.parseInt(configProperties
                .getProperty("WarehouseAutoCapacity", DEFAULT_VALUE));
        return warehouseAutoCapacity;
    }

    public int getSupplierCount(){
        int supplierCount = Integer.parseInt(configProperties
                .getProperty("SuppliersCount", DEFAULT_VALUE));
        return supplierCount;
    }

    public int getWorkerCount(){
        int workerCount = Integer.parseInt(configProperties
                .getProperty("WorkersCount", DEFAULT_VALUE));
        return workerCount;
    }
