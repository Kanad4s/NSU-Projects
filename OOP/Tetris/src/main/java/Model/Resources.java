...
public class Resources {
    public static final String PATH_RESOURCES = "../Tetris/src/main/resources/";
    public static final String PATH_ASSETS = "../Tetris/src/main/resources/Assets/";
    public static final String PATH_RECORD_TABLE = "../Tetris/src/main/resources/RecordTable.txt";
    public static final String PATH_HERO = "../Tetris/src/main/resources/Assets/Hero.png";
    public static final String PATH_RICKY = "../Tetris/src/main/resources/Assets/Ricky.png";
